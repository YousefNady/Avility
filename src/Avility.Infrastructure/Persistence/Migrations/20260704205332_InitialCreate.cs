        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Industry = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    WebsiteUrl = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    LogoUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CompanySize = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    ...
                    LocationCountry = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    LocationGovernorate = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    LocationCity = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Headline = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ...
                    CurrentJobTitle = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    ...
                    PortfolioUrl = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    LocationCountry = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    LocationGovernorate = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    LocationCity = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplacedByTokenHash = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Requirements = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    ...
                    LocationGovernorate = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    LocationCity = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    SalaryCurrency = table.Column<string>(type: "TEXT", maxLength: 3, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CoverLetter = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), "00000000-0000-0000-0000-000000000001", "A person seeking employment through the platform.", "JobSeeker", "JOBSEEKER" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), "00000000-0000-0000-0000-000000000002", "An employer posting jobs and reviewing applicants.", "Company", "COMPANY" },
                    { new Guid("00000000-0000-0000-0000-000000000003"), "00000000-0000-0000-0000-000000000003", "Platform administrator with moderation and verification privileges.", "Admin", "ADMIN" }
                });
